...
<template>
    <div class="lab-result mt-5">
            <h2 class="font-bold m-0 my-2">Lab Results</h2>
            <div class="lab-result-list pr-2">
                <div v-for="test in userStore.activeUsers.lab_results" class="flex justify-between p-1 mb-2 hover:bg-slate-100 cursor-pointer text-slate-500">
                    <span>{{ test }}</span>
                    <span>
