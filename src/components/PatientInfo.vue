...
<template>
    <div class="patient-info">
                    <img :src="userStore.getactiveUsers.profile_picture" alt="" class="m-auto h-[150px]" />
                    <div class="mt-1">
                        <h2 class="text-center my-4 font-semibold">{{ userStore.getactiveUsers.name }}</h2>
                        <div class="flex items-center gap-2 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 42 42">
                                <g id="BirthIcon" transform="translate(-1235 -471)">
                                    <circle id="Ellipse_9" data-name="Ellipse 9" cx="21" cy="21" r="21"
                                        transform="translate(1235 471)" fill="#f6f7f8" />
                                    <path id="calendar_today_FILL0_wght300_GRAD0_opsz24"
                                        ...
                                        transform="translate(1106.999 1346.614)" fill="#072635" />
                                </g>
                            </svg>
                            <p class="patientinfo">
                                <span class="text-slate-500 font-semibold">Date of Birth:</span>
                                <br />
                                <span class="text-slate-900 font-semibold dob">{{ new Date(userStore.getactiveUsers.date_of_birth).toLocaleDateString('en-US', options) }}</span>
                            </p>
                        </div>
                        <div class="flex items-center gap-2 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 42 42">
                                <g id="FemaleIcon" transform="translate(-1235 -471)">
                                    <circle id="Ellipse_9" data-name="Ellipse 9" cx="21" cy="21" r="21"
                                        transform="translate(1235 471)" fill="#f6f7f8" />
                                    <path id="female_FILL0_wght300_GRAD0_opsz24"
                                        ...
                                        transform="translate(979.999 1271.999)" fill="#072635" />
                                </g>
                            </svg>
                            <p class="">
                                <span class=" text-slate-500 font-semibold">Gender:</span>
                                <br />
                                <span class="text-slate-900 font-semibold gender">{{ userStore.getactiveUsers.gender }}</span>
                            </p>
                        </div>
                        <div class="flex items-center gap-2 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 42 42">
                                <g id="PhoneIcon" transform="translate(-1235 -471)">
                                    <circle id="Ellipse_9" data-name="Ellipse 9" cx="21" cy="21" r="21"
                                        transform="translate(1235 471)" fill="#f6f7f8" />
                                    <path id="call_FILL0_wght300_GRAD0_opsz24"
                                        ...
                                        transform="translate(1105.999 1301.999)" fill="#072635" />
                                </g>
                            </svg>
                            <p class="">
                                <span class=" text-slate-500 font-semibold">Contact Info:</span>
                                <br />
                                <span class="text-slate-900 font-semibold contact">{{ userStore.getactiveUsers.phone_number }}</span>
                            </p>
                        </div>
                        <div class="flex items-center gap-2 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 42 42">
                            ...
                            <p class="">
                                <span class=" text-slate-500 font-semibold">Emergency Contacts:</span>
                                <br />
                                <span class="text-slate-900 font-semibold econtact">{{  userStore.getactiveUsers.emergency_contact }}</span>
                            </p>
                        </div>
                        <div class="flex items-center gap-2 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 42 42">
                                <g id="InsuranceIcon" transform="translate(-1235 -471)">
                                    <circle id="Ellipse_9" data-name="Ellipse 9" cx="21" cy="21" r="21"
                                        transform="translate(1235 471)" fill="#f6f7f8" />
                                    <path id="verified_user_FILL0_wght300_GRAD0_opsz24"
                                        ...
                                        transform="translate(1067.999 1335.229)" fill="#072635" />
                                </g>
                            </svg>
                            <p class="">
                                <span class=" text-slate-500 font-semibold">Insurance Provider:</span>
                                <br />
                                <span class="text-slate-900 font-semibold insurancepro">{{ userStore.getactiveUsers.insurance_type }}</span>
                            </p>
                        </div>
                    </div>
                    <div class="showall m-auto py-2 px-4 text-center font-medium mt-8 cursor-pointer">
